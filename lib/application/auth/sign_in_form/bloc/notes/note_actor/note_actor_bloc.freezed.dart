...
// ignore: unused_element
  _Deleted deleted(NoteEntity note) {
    return _Deleted(
      note,
    );
  }
...
mixin _$NoteActorEvent {
  ...
  Result when<Result extends Object>({
    @required Result deleted(NoteEntity note),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result deleted(NoteEntity note),
...
class __$DeletedCopyWithImpl<$Res> extends _$NoteActorEventCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Deleted(
      note == freezed ? _value.note : note as NoteEntity,
    ));
  }
}
...
abstract class _Deleted implements NoteActorEvent {
  const factory _Deleted(NoteEntity note) = _$_Deleted;
